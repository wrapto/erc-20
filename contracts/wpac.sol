...
contract WrappedPAC is Initializable, OwnableUpgradeable, PausableUpgradeable, ERC20Upgradeable, UUPSUpgradeable {
	...
	struct BridgeEvent {
		...
		string pactusAddress; // Pactus blockchain address that will receive the coins
	}
	 ...
	 * @param value The amount of WPAC tokens to bridge
	 */
	function adminBridge(string memory pactusAddress, uint256 value) public whenNotPaused OnlyMinter(_msgSender()) {
		_bridge(pactusAddress, value);
	}
